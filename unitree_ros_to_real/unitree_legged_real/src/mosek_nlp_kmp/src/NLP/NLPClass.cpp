  ...
  {       
    ...
    {  
	  ...
	  //cout<< "t_desxxy_rfoot"<<t_desxx + 2*_td(_bjx1-1,0)/4<<endl;
          ...
          _Rfoot_rv(1,0) =  0.075*(_footxyz_real(0,_bjx1)-_footxyz_real(0,_bjx1-1))/(_footx_max) * (4*M_PI / (_ts(_bjx1-1,0)) * (-sin(4*M_PI / (_ts(_bjx1-1,0)) * (t_desxx + 2*_td(_bjx1-1,0)/4))));
...
/*	if ((_footxyz_real(0,_bjx1)-_footxyz_real(0,_bjx1-1))>0)
    ...
    {      
	  ...
	  //cout<< "t_desxxy_lfoot"<<t_desxx + 2*_td(_bjx1-1,0)/4<<endl;
          ...
          _Lfoot_rv(1,0) =  0.075*(_footxyz_real(0,_bjx1)-_footxyz_real(0,_bjx1-1))/(_footx_max) * (4*M_PI / (_ts(_bjx1-1,0)) * (-sin(4*M_PI / (_ts(_bjx1-1,0)) * (t_desxx + 2*_td(_bjx1-1,0)/4))));
