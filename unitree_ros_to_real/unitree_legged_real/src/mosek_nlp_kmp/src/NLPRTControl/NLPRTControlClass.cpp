...
//       Rfootxyzx = RightFootPosx = nlp.XGetSolution_Foot_positionR(_walkdtime1, _dtx, FootR_in1,FootR_in2,FootR_in3);
    ...
    // ///
    // body_thetax(0) = (RightFootRPY(0) + LeftFootRPY(0))/5;
    // body_thetax(1) = (RightFootRPY(1) + LeftFootRPY(1))/5;
    // body_thetax(2) = (RightFootRPY(2) + LeftFootRPY(2))/2;
